...
cp make_psi.ksh tmp_make_psi_TROPICO12-${CASE}-${YEAR}.ksh
sed -i 's/YEARM/'$YEAR'/g' tmp_make_psi_TROPICO12-${CASE}-${YEAR}.ksh
sed -i 's/CASEM/'$CASE'/g' tmp_make_psi_TROPICO12-${CASE}-${YEAR}.ksh
sed -i 's/CONFIGM/TROPICO12/g' tmp_make_psi_TROPICO12-${CASE}-${YEAR}.ksh
